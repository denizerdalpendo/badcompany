                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        const previousValue = notifications.email_notifications;
                        setNotifications((prev) => ({
                          ...prev,
                          email_notifications: newValue,
                        }));
                        if (typeof pendo !== "undefined") {
                          pendo.track("notification_preferences_changed", {
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700 rounded-lg">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      className="sr-only peer"
                      checked={notifications.report_ready_alerts}
                      onChange={(e) => {
                        const newValue = e.target.checked;
                        const previousValue = notifications.report_ready_alerts;
                        setNotifications((prev) => ({
                          ...prev,
                          report_ready_alerts: newValue,
                        }));
                        if (typeof pendo !== "undefined") {
                          pendo.track("notification_preferences_changed", {
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700 rounded-lg">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      className="sr-only peer"
                      checked={notifications.api_usage_warnings}
                      onChange={(e) => {
                        const newValue = e.target.checked;
                        const previousValue = notifications.api_usage_warnings;
                        setNotifications((prev) => ({
                          ...prev,
                          api_usage_warnings: newValue,
                        }));
                        if (typeof pendo !== "undefined") {
                          pendo.track("notification_preferences_changed", {
